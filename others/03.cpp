    ...
    nodeType *search( string name ) {
        ...
        while ( cur != NULL ) {
            ...
            // case 2 two key
                ...
                // cout << endl << "[]" << cur->data[0].key << " " << cur->data[1].key << endl << endl ; // debug line
                // duplicate key01
                if ( !name.compare( cur->data[0].key ) ) {
                    return cur ;
                }
...
/*
            cout << pNode->data[0].key << " " << pNode->data[1].key << " " << pNode->data[2].key << endl ; // debug line
            cout << "[0] < [1] " << (pNode->data[0].key.compare( pNode->data[1].key )<0) << endl ; // debug line
            cout << "[1] < [2] " << (pNode->data[1].key.compare( pNode->data[2].key )<0) << endl ; // debug line
            cout << "[0] < [2] " << (pNode->data[0].key.compare( pNode->data[2].key )<0) << endl ; // debug line
*/
...
/*
                ...
                cout << "[  " << n1->data[0].key << "  ]" << '\t' ;
                cout << "[  " << n2->data[0].key << "  ]" << '\t' ;
                cout << "[  " << pNode->link[0]->data[0].key << "  ]" << '\t' ;
                cout << "[  " << pNode->link[2]->data[0].key << "  ]" << endl ;
*/
...
public:
    ...
    void insert23tree( int newRid, string newKey ) {
        ...
        if ( root == NULL ) {
            ...
            // cout << "build root success" << endl ; // debug
        }
            ...
            if ( cur != NULL ) {
                ...
                if ( !cur->data[0].rSet.empty() && cur->data[1].rSet.empty() ) {
                    ...
                    if ( !newKey.compare( cur->data[0].key ) ) {
                        ...
                        // cout << newKey << " " << cur->data[0].key << " Duplicate!" << endl ; // debug line
                    }
                    // newkey > key01
                ...
                // case 2 two key
                    ...
                    // duplicate key02
                        ...
                        // cout << newKey << " " << cur->data[1].key << " Duplicate!" << endl ; // debug line
                    }
                    // newkey < key01
                    else if ( newKey.compare( cur->data[0].key ) < 0 ) {
    ...
    void Height(  ) {
        ...
        while ( temp!= NULL ) {
            ...
            /* cout << temp->data[0].key ; //debug line
            if ( !temp->data[1].rSet.empty() )
                cout << " " << temp->data[1].key ;
            cout << endl ;
            */
            temp = temp->link[0] ;
            height++ ;
...
/*
        ...
        while ( tmp!= NULL ) {
            ...
            cout << tmp->data[0].key ; //debug line
            if ( !tmp->data[1].rSet.empty() )
                cout << " " << tmp->data[1].key ;
            cout << endl ;
            ...
            case 1:
                ...
                if (dataList.ReadFile( "input" )) {
                    ...
                    for( int i = 0 ; i < dataList.GetSize() ; i++ ) {
                        ...
                        // cout << i+1 << endl << "insert: " << dataList.GetData( i, 1 ) << "" << endl ; // debug line
