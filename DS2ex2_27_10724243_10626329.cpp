        ...
        switch ( command ) {
            ...
            case 3:
                ...
                if (dataList.ReadFile( "input" )) {
                    ...
                    // AVL Tree Case
                    if ( !avlKey.compare("*") ) ; // skip search
                    else if ( avlTree.find( avlKey, avlDataPos) ) {
                    ...
                    // 2-3 Tree Case
                    if ( !tree23Key.compare("*") ) ; // skip search
                    else if ( tree23.find( tree23Key, tree23DataPos) ) {
                        cout << "[info] College searching Success! " << endl ;
                    }
                    else {
                        cout << "[info] Cannot find out the college name! " << endl << endl ;
                    }
                    ...
                    if ( !avlKey.compare("*") && !tree23Key.compare("*") ) {
                        cout << "[info] It's input201 all data!" << endl ;
                        cout << "[info] Please try again" << endl ;
                    }
                    // dont' care college
                    else if ( !tree23Key.compare("*") ) {
                        for( int i = 0 ; i < avlDataPos.size() ; i++ ) {
                            cout << num << " [" << avlDataPos.at(i) << "]" << '\t' ;       // id
                    ...
                    else if ( !avlKey.compare("*") ) {
                        for( int i = 0 ; i < tree23DataPos.size() ; i++ ) {
                            cout << num << " [" << tree23DataPos.at(i) << "]" << '\t' ;       // id
                    ...
                    // same department name
                        ...
                        for( int i = 0 ; i < tree23DataPos.size() ; i++ ) {
                            if ( !dataList.GetData( tree23DataPos.at(i)-1, 3 ).compare( avlKey ) ) {
                                cout << num << " [" << tree23DataPos.at(i) << "]" << '\t' ;       // id
                                cout << dataList.GetData( tree23DataPos.at(i)-1, 1 ) << '\t' ;    // school name
                                cout << dataList.GetData( tree23DataPos.at(i)-1, 3 ) << '\t' ;    // department name
                                cout << dataList.GetData( tree23DataPos.at(i)-1, 4 ) << '\t' ;    // day/night
